...
export async function getUserPoints (db: Database, username: string): Promise<number> {
...
export async function getLoyaltyRecord (db: Database, username: string): Promise<any> {
  return await new Promise((resolve, reject) => {
...
export async function updateUserPoints (db: Database, username: string, pointsToAdd: number): Promise<void> {
