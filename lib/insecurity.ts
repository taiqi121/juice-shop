...
// Load private key from environment variable or file for security
const privateKey = process.env.JWT_PRIVATE_KEY || (fs ? fs.readFileSync('encryptionkeys/jwt.key', 'utf8') : 'placeholder-private-key')
...
// Load HMAC secret from environment variable or secure configuration
